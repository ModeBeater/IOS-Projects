//
//  ForgotPasswordPageSecond.swift
//  ASDS_CLUB
//
...
class ForgotPasswordPageSecond: UIViewController {
...
//        navigationController.pushViewController(RegisterPage(), animated: true)
    ...
    @objc func sendPressed() {
        ...
        navigationController.pushViewController(ForgotPasswordPageThird(), animated: true)
    }
